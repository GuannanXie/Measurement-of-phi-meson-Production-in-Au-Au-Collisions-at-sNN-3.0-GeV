...
\begin{tabular}{cccc} \hline \hline
  Variable  & $\phi$ Yield [10^-2/evt] & $\phi$ $T_{eff}$ & $K^-$ Yield [10^-1/evt] & $K^-$ $T_{eff}$ & $\phi/K^-$   \\ \hline
  0--10\%   & & &  &  & $0.230\pm0.016_{stat}\pm0.042_{sys}$ \\
  10--40\%  & & &  &  & $0.245\pm0.012_{stat}\pm0.048_{sys}$ \\
  40--60\%  & & &  &  & $0.344\pm0.026_{stat}\pm0.072_{sys}$ \\ \hline \hline
\end{tabular}
}
