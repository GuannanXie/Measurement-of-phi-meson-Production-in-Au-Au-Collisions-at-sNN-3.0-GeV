...
$r_c$ is an approximation in CE for reproducing the strange production in heavy-ion collisions. It is unclear if the same value of $r_c$ should fit to S=1 (e.g. Kaon) and S=2 (e.g. $\Xi^-$). On the other hand, transport model calculations~\cite{Steinheimer_2015_UrQMD,Elfner_SMASH:2019} with high mass strange resonances reproduce the data implying that the feed down is of relevance.
