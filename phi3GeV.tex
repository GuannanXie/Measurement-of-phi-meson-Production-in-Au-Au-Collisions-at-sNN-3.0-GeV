...
The enhancement of $\phi/K^-$ and $\phi/\Xi^-$ were also observed at lower collision energy in ${\sqrt{s_{\rm NN}} = \rm{2.4\,GeV}}$ Au+Au~\cite{HADES_phi_AuAu:2018} and  ${\sqrt{s_{\rm NN}} = \rm{2.6\,GeV}}$ Ar+Cl collisions~\cite{HADES_phi_ArKCl:2009,Xi_ArKCl_HADES:2009}, respectively.
